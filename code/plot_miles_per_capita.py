...
data = [ dict(
            ...
            z = df['MILECAPITA'].astype(float),
            locationmode = 'USA-states',
            text = 'Annual Miles Traveled Per Capita',
            marker = dict(
...
layout = dict(
        title = 'US Miles Traveled by State Per Capita',
        geo = dict(
            scope='usa',
...
url = plotly.plot( fig, filename='miles_traveled_per_capita_map' )
