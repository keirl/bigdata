...
data = [ dict(
            ...
            z = df['AVGMILE'].astype(float),
            locationmode = 'USA-states',
            text = 'Annual Miles Traveled Per Registered Automobile',
            marker = dict(
...
layout = dict(
        title = 'US Miles Traveled by State Per Registered Auto',
        geo = dict(
            scope='usa',
...
url = plotly.plot( fig, filename='miles_traveled_per_auto_map' )
