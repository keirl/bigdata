...
data = [ dict(
            ...
            z = df['AVGGAS'].astype(float),
            locationmode = 'USA-states',
            text = 'Annual Gasoline Consumption Per Registered Automobile',
            marker = dict(
...
layout = dict(
        title = 'US Gasoline Consumption by State Per Registered Auto',
        geo = dict(
            scope='usa',
...
url = plotly.plot( fig, filename='gasoline_consumption_per_auto_map' )
